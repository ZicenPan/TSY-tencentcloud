...
export default class App extends React.Component<{}, State> {
  ...
  handleNext = () => {
    ...
    if (this.state.step < this.state.cap) {
      this.setState(() => ({
        step: this.state.step + 1,
        data: initData.stages[this.state.stage + 1].steps![this.state.step + 1]
      }))
    } else {
      this.setState(() => ({
    ...
    console.log("afterNext: ", this.state.stage, " ", this.state.step);
  }
